    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className={"pt-16"}>
          <AnimatedText
            text={"Passion fuels Me"}
            className={
              "!text-6xl mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8"
            }
          />
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium text-dark dark:text-light">
                I have always had a natural talent for technology and working
                with computers. In 2005, I began working with HTML and CSS to
                make some minor edits on a small business website that I was
                running. What I initially thought would be just a few small
                changes turned into a passion for programming.
              </p>
              <p className="my-4 font-medium text-dark dark:text-light">
                ...
                more enthused with making websites interactive. I am now
                spending my time building projects with Next JS, Typescript,
                AWS, Azure and learning new technologies.
              </p>
              <p className="my-4 font-medium text-dark dark:text-light">
                I excel in software architecture, design patterns, and agile
                methodologies to deliver high-quality projects on time. I have
                excellent communication skills, collaborate well with teams, and
                share my knowledge with the tech community through open-source
                contributions.
              </p>
            </div>
