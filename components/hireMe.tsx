...
export default function HireMeFloater() {
    return (
        <div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute">
            <div className="w-48 auto flex items-center justify-center relative md:w-24">
                <Link href={"mailto:vatsalparmar98@gmail.com"}
