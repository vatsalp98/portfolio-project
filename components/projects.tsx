        ...
        <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative">
            ...
            <div className="w-full flex flex-col items-start justify-between pt-4">
                ...
                <div className="w-full mt-2 flex items-center justify-between">
                    <Link href={props.link} target="_blank" className="text-lg font-semibold"> Visit Project</Link>
                    <Link href={props.github} target="_blank" className="w-8"> <GithubFilled style={{fontSize: "34px"}}/></Link>
                </div>
            </div>
        </article>
    );
